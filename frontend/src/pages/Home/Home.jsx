    ...
    <div>
      ...
      <section className="hero">
        <div className="hero-content">
          <h1>Welcome to Jeerayz Solar</h1>
      ...
      <section className="about">
        <h2>About Us</h2>
        <p>
          At Jeerayz Solar, we are dedicated to providing high-quality solar panel installation services to help you harness the power of the sun. Our team of experts ensures a seamless and efficient installation process that maximizes energy output and savings.
        </p>
      </section>
      ...
      <section className="features">
        ...
        <div className="feature-list">
          <div className="feature-item">
            <h3>Higher Efficiency Products</h3>
      ...
      <section className="testimonials">
        ...
        <div className="testimonial-list">
          <div className="testimonial-item">
            <p>"Jeerayz Solar made the entire process easy and stress-free. Our energy bills have significantly reduced!"</p>
          </div>
          <div className="testimonial-item">
            <p>"Highly recommend Jeerayz Solar for their professionalism and quality service."</p>
          </div>
        </div>
      </section>
      ...
      <section className="call-to-action">
        ...
        {showContactDetails && (
          <div className="contact-details">
            ...
            <p><strong>Email:</strong> jeerayzsolar@gmail.com</p>
            <p><strong>Phone:</strong> <a href="tel:9345576725">9345576725</a></p> 
          </div>
        )}
      </section>
    </div>
